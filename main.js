...
$("#card li:eq("+i+") img").stop().animate({ width: "0",height: "64px"}, speed,
function(){
n(i);
});
}
...
$("#card li:eq("+index+") img").stop().animate({ width: "64px",height: "64px"}, speed);
$("#card li:eq("+index+")").stop().animate({ left: "0"}, speed);
}
//uraOpen
function uraOpen(j){
$("#card li:eq("+j+") img").attr("src","img/card.png");
$("#card li:eq("+j+") img").stop().animate({ width: "64px",height: "64px"}, speed);
